...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Seed discovery using a local SearXNG instance",
    )
    ...
    parser.add_argument("--output", default="data/staging/discovered-searxng.jsonl")
    ...
    parser.add_argument(
        ...
        help="Base URL of the SearXNG instance (default: http://localhost:8080)",
    )
    parser.add_argument(
        "--searxng-engines",
        help="Comma-separated SearXNG engine names to force for this run (example: mojeek)",
    )
