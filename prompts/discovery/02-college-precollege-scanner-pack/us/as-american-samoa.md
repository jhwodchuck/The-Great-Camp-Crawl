# Copy-Paste Discovery Prompt: US / AS / American Samoa — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-as-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-as-college-precollege-scan`
- `country`: `US`
- `region`: `AS`
...
- `site:.edu "American Samoa" "pre-college" residential`
- `site:.edu "American Samoa" "summer program" residential overnight`
- `site:.edu "American Samoa" "summer immersion" OR "summer institute" residential`
- `"American Samoa" university "summer camp" residential "high school"`
- `"American Samoa" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-as-college-precollege-scan.json` if you can write files.
