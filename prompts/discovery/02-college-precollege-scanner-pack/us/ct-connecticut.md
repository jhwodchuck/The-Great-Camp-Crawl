# Copy-Paste Discovery Prompt: US / CT / Connecticut — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-ct-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-ct-college-precollege-scan`
- `country`: `US`
- `region`: `CT`
...
- `site:.edu "Connecticut" "pre-college" residential`
- `site:.edu "Connecticut" "summer program" residential overnight`
- `site:.edu "Connecticut" "summer immersion" OR "summer institute" residential`
- `"Connecticut" university "summer camp" residential "high school"`
- `"Connecticut" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-ct-college-precollege-scan.json` if you can write files.
