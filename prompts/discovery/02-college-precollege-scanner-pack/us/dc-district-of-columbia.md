# Copy-Paste Discovery Prompt: US / DC / District of Columbia — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-dc-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-dc-college-precollege-scan`
- `country`: `US`
- `region`: `DC`
...
- `site:.edu "District of Columbia" "pre-college" residential`
- `site:.edu "District of Columbia" "summer program" residential overnight`
- `site:.edu "District of Columbia" "summer immersion" OR "summer institute" residential`
- `"District of Columbia" university "summer camp" residential "high school"`
- `"District of Columbia" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-dc-college-precollege-scan.json` if you can write files.
