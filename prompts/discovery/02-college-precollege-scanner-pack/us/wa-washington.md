# Copy-Paste Discovery Prompt: US / WA / Washington — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-wa-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-wa-college-precollege-scan`
- `country`: `US`
- `region`: `WA`
...
- `site:.edu "Washington" "pre-college" residential`
- `site:.edu "Washington" "summer program" residential overnight`
- `site:.edu "Washington" "summer immersion" OR "summer institute" residential`
- `"Washington" university "summer camp" residential "high school"`
- `"Washington" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-wa-college-precollege-scan.json` if you can write files.
