# Copy-Paste Discovery Prompt: US / NE / Nebraska — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-ne-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-ne-college-precollege-scan`
- `country`: `US`
- `region`: `NE`
...
- `site:.edu "Nebraska" "pre-college" residential`
- `site:.edu "Nebraska" "summer program" residential overnight`
- `site:.edu "Nebraska" "summer immersion" OR "summer institute" residential`
- `"Nebraska" university "summer camp" residential "high school"`
- `"Nebraska" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-ne-college-precollege-scan.json` if you can write files.
