# Copy-Paste Discovery Prompt: US / WY / Wyoming — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-wy-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-wy-college-precollege-scan`
- `country`: `US`
- `region`: `WY`
- `region_name`: `Wyoming`
...
- `site:.edu "Wyoming" "pre-college" residential`
- `site:.edu "Wyoming" "summer program" residential overnight`
- `site:.edu "Wyoming" "summer immersion" OR "summer institute" residential`
- `"Wyoming" university "summer camp" residential "high school"`
- `"Wyoming" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-wy-college-precollege-scan.json` if you can write files.
