# Copy-Paste Discovery Prompt: US / SC / South Carolina — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-sc-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-sc-college-precollege-scan`
- `country`: `US`
- `region`: `SC`
...
- `site:.edu "South Carolina" "pre-college" residential`
- `site:.edu "South Carolina" "summer program" residential overnight`
- `site:.edu "South Carolina" "summer immersion" OR "summer institute" residential`
- `"South Carolina" university "summer camp" residential "high school"`
- `"South Carolina" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-sc-college-precollege-scan.json` if you can write files.
