# Copy-Paste Discovery Prompt: US / OH / Ohio — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-oh-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-oh-college-precollege-scan`
- `country`: `US`
- `region`: `OH`
- `region_name`: `Ohio`
...
- `site:.edu "Ohio" "pre-college" residential`
- `site:.edu "Ohio" "summer program" residential overnight`
- `site:.edu "Ohio" "summer immersion" OR "summer institute" residential`
- `"Ohio" university "summer camp" residential "high school"`
- `"Ohio" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-oh-college-precollege-scan.json` if you can write files.
