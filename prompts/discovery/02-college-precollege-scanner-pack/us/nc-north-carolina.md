# Copy-Paste Discovery Prompt: US / NC / North Carolina — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-nc-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-nc-college-precollege-scan`
- `country`: `US`
- `region`: `NC`
...
- `site:.edu "North Carolina" "pre-college" residential`
- `site:.edu "North Carolina" "summer program" residential overnight`
- `site:.edu "North Carolina" "summer immersion" OR "summer institute" residential`
- `"North Carolina" university "summer camp" residential "high school"`
- `"North Carolina" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-nc-college-precollege-scan.json` if you can write files.
