# Copy-Paste Discovery Prompt: US / ND / North Dakota — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-nd-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-nd-college-precollege-scan`
- `country`: `US`
- `region`: `ND`
...
- `site:.edu "North Dakota" "pre-college" residential`
- `site:.edu "North Dakota" "summer program" residential overnight`
- `site:.edu "North Dakota" "summer immersion" OR "summer institute" residential`
- `"North Dakota" university "summer camp" residential "high school"`
- `"North Dakota" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-nd-college-precollege-scan.json` if you can write files.
