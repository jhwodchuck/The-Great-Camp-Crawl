# Copy-Paste Discovery Prompt: US / WV / West Virginia — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-wv-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-wv-college-precollege-scan`
- `country`: `US`
- `region`: `WV`
...
- `site:.edu "West Virginia" "pre-college" residential`
- `site:.edu "West Virginia" "summer program" residential overnight`
- `site:.edu "West Virginia" "summer immersion" OR "summer institute" residential`
- `"West Virginia" university "summer camp" residential "high school"`
- `"West Virginia" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-wv-college-precollege-scan.json` if you can write files.
