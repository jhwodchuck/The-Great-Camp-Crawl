# Copy-Paste Discovery Prompt: US / NJ / New Jersey — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-nj-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-nj-college-precollege-scan`
- `country`: `US`
- `region`: `NJ`
...
- `site:.edu "New Jersey" "pre-college" residential`
- `site:.edu "New Jersey" "summer program" residential overnight`
- `site:.edu "New Jersey" "summer immersion" OR "summer institute" residential`
- `"New Jersey" university "summer camp" residential "high school"`
- `"New Jersey" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-nj-college-precollege-scan.json` if you can write files.
