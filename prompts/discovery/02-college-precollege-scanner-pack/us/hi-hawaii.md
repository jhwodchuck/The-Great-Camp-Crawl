# Copy-Paste Discovery Prompt: US / HI / Hawaii — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-hi-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-hi-college-precollege-scan`
- `country`: `US`
- `region`: `HI`
- `region_name`: `Hawaii`
...
- `site:.edu "Hawaii" "pre-college" residential`
- `site:.edu "Hawaii" "summer program" residential overnight`
- `site:.edu "Hawaii" "summer immersion" OR "summer institute" residential`
- `"Hawaii" university "summer camp" residential "high school"`
- `"Hawaii" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-hi-college-precollege-scan.json` if you can write files.
