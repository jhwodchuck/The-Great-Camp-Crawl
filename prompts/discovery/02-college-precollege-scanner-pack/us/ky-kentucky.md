# Copy-Paste Discovery Prompt: US / KY / Kentucky — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-ky-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-ky-college-precollege-scan`
- `country`: `US`
- `region`: `KY`
...
- `site:.edu "Kentucky" "pre-college" residential`
- `site:.edu "Kentucky" "summer program" residential overnight`
- `site:.edu "Kentucky" "summer immersion" OR "summer institute" residential`
- `"Kentucky" university "summer camp" residential "high school"`
- `"Kentucky" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-ky-college-precollege-scan.json` if you can write files.
