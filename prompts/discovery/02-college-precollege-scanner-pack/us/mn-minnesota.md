# Copy-Paste Discovery Prompt: US / MN / Minnesota — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-mn-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-mn-college-precollege-scan`
- `country`: `US`
- `region`: `MN`
...
- `site:.edu "Minnesota" "pre-college" residential`
- `site:.edu "Minnesota" "summer program" residential overnight`
- `site:.edu "Minnesota" "summer immersion" OR "summer institute" residential`
- `"Minnesota" university "summer camp" residential "high school"`
- `"Minnesota" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-mn-college-precollege-scan.json` if you can write files.
