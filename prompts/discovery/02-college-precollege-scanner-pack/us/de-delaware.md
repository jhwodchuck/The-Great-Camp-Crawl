# Copy-Paste Discovery Prompt: US / DE / Delaware — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-de-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-de-college-precollege-scan`
- `country`: `US`
- `region`: `DE`
...
- `site:.edu "Delaware" "pre-college" residential`
- `site:.edu "Delaware" "summer program" residential overnight`
- `site:.edu "Delaware" "summer immersion" OR "summer institute" residential`
- `"Delaware" university "summer camp" residential "high school"`
- `"Delaware" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-de-college-precollege-scan.json` if you can write files.
