# Copy-Paste Discovery Prompt: US / NH / New Hampshire — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-nh-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-nh-college-precollege-scan`
- `country`: `US`
- `region`: `NH`
...
- `site:.edu "New Hampshire" "pre-college" residential`
- `site:.edu "New Hampshire" "summer program" residential overnight`
- `site:.edu "New Hampshire" "summer immersion" OR "summer institute" residential`
- `"New Hampshire" university "summer camp" residential "high school"`
- `"New Hampshire" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-nh-college-precollege-scan.json` if you can write files.
