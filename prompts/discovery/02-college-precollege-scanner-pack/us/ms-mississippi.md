# Copy-Paste Discovery Prompt: US / MS / Mississippi — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-ms-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-ms-college-precollege-scan`
- `country`: `US`
- `region`: `MS`
...
- `site:.edu "Mississippi" "pre-college" residential`
- `site:.edu "Mississippi" "summer program" residential overnight`
- `site:.edu "Mississippi" "summer immersion" OR "summer institute" residential`
- `"Mississippi" university "summer camp" residential "high school"`
- `"Mississippi" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-ms-college-precollege-scan.json` if you can write files.
