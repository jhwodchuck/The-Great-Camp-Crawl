# Copy-Paste Discovery Prompt: US / PR / Puerto Rico — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-pr-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-pr-college-precollege-scan`
- `country`: `US`
- `region`: `PR`
...
- `site:.edu "Puerto Rico" "pre-college" residential`
- `site:.edu "Puerto Rico" "summer program" residential overnight`
- `site:.edu "Puerto Rico" "summer immersion" OR "summer institute" residential`
- `"Puerto Rico" university "summer camp" residential "high school"`
- `"Puerto Rico" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-pr-college-precollege-scan.json` if you can write files.
