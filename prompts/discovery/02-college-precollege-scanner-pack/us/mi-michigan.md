# Copy-Paste Discovery Prompt: US / MI / Michigan — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-mi-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-mi-college-precollege-scan`
- `country`: `US`
- `region`: `MI`
...
- `site:.edu "Michigan" "pre-college" residential`
- `site:.edu "Michigan" "summer program" residential overnight`
- `site:.edu "Michigan" "summer immersion" OR "summer institute" residential`
- `"Michigan" university "summer camp" residential "high school"`
- `"Michigan" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-mi-college-precollege-scan.json` if you can write files.
