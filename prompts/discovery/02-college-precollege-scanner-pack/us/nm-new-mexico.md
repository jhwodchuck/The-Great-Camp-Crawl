# Copy-Paste Discovery Prompt: US / NM / New Mexico — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-nm-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-nm-college-precollege-scan`
- `country`: `US`
- `region`: `NM`
...
- `site:.edu "New Mexico" "pre-college" residential`
- `site:.edu "New Mexico" "summer program" residential overnight`
- `site:.edu "New Mexico" "summer immersion" OR "summer institute" residential`
- `"New Mexico" university "summer camp" residential "high school"`
- `"New Mexico" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-nm-college-precollege-scan.json` if you can write files.
