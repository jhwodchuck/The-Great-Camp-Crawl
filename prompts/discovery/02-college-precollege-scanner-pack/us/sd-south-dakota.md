# Copy-Paste Discovery Prompt: US / SD / South Dakota — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-sd-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-sd-college-precollege-scan`
- `country`: `US`
- `region`: `SD`
...
- `site:.edu "South Dakota" "pre-college" residential`
- `site:.edu "South Dakota" "summer program" residential overnight`
- `site:.edu "South Dakota" "summer immersion" OR "summer institute" residential`
- `"South Dakota" university "summer camp" residential "high school"`
- `"South Dakota" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-sd-college-precollege-scan.json` if you can write files.
