# Copy-Paste Discovery Prompt: US / CA / California — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-ca-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-ca-college-precollege-scan`
- `country`: `US`
- `region`: `CA`
...
- `site:.edu "California" "pre-college" residential`
- `site:.edu "California" "summer program" residential overnight`
- `site:.edu "California" "summer immersion" OR "summer institute" residential`
- `"California" university "summer camp" residential "high school"`
- `"California" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-ca-college-precollege-scan.json` if you can write files.
