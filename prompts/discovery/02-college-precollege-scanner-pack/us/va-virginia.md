# Copy-Paste Discovery Prompt: US / VA / Virginia — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-va-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-va-college-precollege-scan`
- `country`: `US`
- `region`: `VA`
...
- `site:.edu "Virginia" "pre-college" residential`
- `site:.edu "Virginia" "summer program" residential overnight`
- `site:.edu "Virginia" "summer immersion" OR "summer institute" residential`
- `"Virginia" university "summer camp" residential "high school"`
- `"Virginia" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-va-college-precollege-scan.json` if you can write files.
