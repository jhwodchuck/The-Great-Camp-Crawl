# Copy-Paste Discovery Prompt: US / MD / Maryland — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-md-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-md-college-precollege-scan`
- `country`: `US`
- `region`: `MD`
...
- `site:.edu "Maryland" "pre-college" residential`
- `site:.edu "Maryland" "summer program" residential overnight`
- `site:.edu "Maryland" "summer immersion" OR "summer institute" residential`
- `"Maryland" university "summer camp" residential "high school"`
- `"Maryland" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-md-college-precollege-scan.json` if you can write files.
