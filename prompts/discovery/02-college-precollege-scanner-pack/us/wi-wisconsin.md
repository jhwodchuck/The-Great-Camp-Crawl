# Copy-Paste Discovery Prompt: US / WI / Wisconsin — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-wi-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-wi-college-precollege-scan`
- `country`: `US`
- `region`: `WI`
...
- `site:.edu "Wisconsin" "pre-college" residential`
- `site:.edu "Wisconsin" "summer program" residential overnight`
- `site:.edu "Wisconsin" "summer immersion" OR "summer institute" residential`
- `"Wisconsin" university "summer camp" residential "high school"`
- `"Wisconsin" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-wi-college-precollege-scan.json` if you can write files.
