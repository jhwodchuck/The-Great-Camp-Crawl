# Copy-Paste Discovery Prompt: US / VI / U.S. Virgin Islands — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-vi-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-vi-college-precollege-scan`
- `country`: `US`
- `region`: `VI`
...
- `site:.edu "U.S. Virgin Islands" "pre-college" residential`
- `site:.edu "U.S. Virgin Islands" "summer program" residential overnight`
- `site:.edu "U.S. Virgin Islands" "summer immersion" OR "summer institute" residential`
- `"U.S. Virgin Islands" university "summer camp" residential "high school"`
- `"U.S. Virgin Islands" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-vi-college-precollege-scan.json` if you can write files.
