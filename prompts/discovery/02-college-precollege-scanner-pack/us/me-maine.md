# Copy-Paste Discovery Prompt: US / ME / Maine — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-me-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-me-college-precollege-scan`
- `country`: `US`
- `region`: `ME`
- `region_name`: `Maine`
...
- `site:.edu "Maine" "pre-college" residential`
- `site:.edu "Maine" "summer program" residential overnight`
- `site:.edu "Maine" "summer immersion" OR "summer institute" residential`
- `"Maine" university "summer camp" residential "high school"`
- `"Maine" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-me-college-precollege-scan.json` if you can write files.
