# Copy-Paste Discovery Prompt: US / AK / Alaska — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-ak-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-ak-college-precollege-scan`
- `country`: `US`
- `region`: `AK`
- `region_name`: `Alaska`
...
- `site:.edu "Alaska" "pre-college" residential`
- `site:.edu "Alaska" "summer program" residential overnight`
- `site:.edu "Alaska" "summer immersion" OR "summer institute" residential`
- `"Alaska" university "summer camp" residential "high school"`
- `"Alaska" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-ak-college-precollege-scan.json` if you can write files.
