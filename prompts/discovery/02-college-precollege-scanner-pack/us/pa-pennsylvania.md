# Copy-Paste Discovery Prompt: US / PA / Pennsylvania — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-pa-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-pa-college-precollege-scan`
- `country`: `US`
- `region`: `PA`
...
- `site:.edu "Pennsylvania" "pre-college" residential`
- `site:.edu "Pennsylvania" "summer program" residential overnight`
- `site:.edu "Pennsylvania" "summer immersion" OR "summer institute" residential`
- `"Pennsylvania" university "summer camp" residential "high school"`
- `"Pennsylvania" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-pa-college-precollege-scan.json` if you can write files.
