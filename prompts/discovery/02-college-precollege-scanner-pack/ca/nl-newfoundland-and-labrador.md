# Copy-Paste Discovery Prompt: CA / NL / Newfoundland and Labrador — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/ca-nl-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `ca-nl-college-precollege-scan`
- `country`: `CA`
- `region`: `NL`
...
- `site:.ca "Newfoundland and Labrador" "pre-college" residential`
- `site:.ca "Newfoundland and Labrador" "summer program" residential overnight`
- `site:.ca "Newfoundland and Labrador" "summer institute" OR "summer immersion" residential`
- `"Newfoundland and Labrador" university "summer camp" residential "high school"`
- `"Newfoundland and Labrador" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/ca-nl-college-precollege-scan.json` if you can write files.
