# Copy-Paste Discovery Prompt: CA / SK / Saskatchewan — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/ca-sk-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `ca-sk-college-precollege-scan`
- `country`: `CA`
- `region`: `SK`
...
- `site:.ca "Saskatchewan" "pre-college" residential`
- `site:.ca "Saskatchewan" "summer program" residential overnight`
- `site:.ca "Saskatchewan" "summer institute" OR "summer immersion" residential`
- `"Saskatchewan" university "summer camp" residential "high school"`
- `"Saskatchewan" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/ca-sk-college-precollege-scan.json` if you can write files.
