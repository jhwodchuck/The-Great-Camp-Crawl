# Copy-Paste Discovery Prompt: CA / BC / British Columbia — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/ca-bc-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `ca-bc-college-precollege-scan`
- `country`: `CA`
- `region`: `BC`
...
- `site:.ca "British Columbia" "pre-college" residential`
- `site:.ca "British Columbia" "summer program" residential overnight`
- `site:.ca "British Columbia" "summer institute" OR "summer immersion" residential`
- `"British Columbia" university "summer camp" residential "high school"`
- `"British Columbia" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/ca-bc-college-precollege-scan.json` if you can write files.
