# Copy-Paste Discovery Prompt: CA / NS / Nova Scotia — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/ca-ns-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `ca-ns-college-precollege-scan`
- `country`: `CA`
- `region`: `NS`
...
- `site:.ca "Nova Scotia" "pre-college" residential`
- `site:.ca "Nova Scotia" "summer program" residential overnight`
- `site:.ca "Nova Scotia" "summer institute" OR "summer immersion" residential`
- `"Nova Scotia" university "summer camp" residential "high school"`
- `"Nova Scotia" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/ca-ns-college-precollege-scan.json` if you can write files.
