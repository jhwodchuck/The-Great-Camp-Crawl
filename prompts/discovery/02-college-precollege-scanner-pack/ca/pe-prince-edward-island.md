# Copy-Paste Discovery Prompt: CA / PE / Prince Edward Island — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/ca-pe-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `ca-pe-college-precollege-scan`
- `country`: `CA`
- `region`: `PE`
...
- `site:.ca "Prince Edward Island" "pre-college" residential`
- `site:.ca "Prince Edward Island" "summer program" residential overnight`
- `site:.ca "Prince Edward Island" "summer institute" OR "summer immersion" residential`
- `"Prince Edward Island" university "summer camp" residential "high school"`
- `"Prince Edward Island" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/ca-pe-college-precollege-scan.json` if you can write files.
