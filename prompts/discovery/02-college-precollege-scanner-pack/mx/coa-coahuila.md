# Copy-Paste Discovery Prompt: MX / COA / Coahuila — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-coa-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-coa-college-precollege-scan`
- `country`: `MX`
- `region`: `COA`
...
- `site:.mx "Coahuila" "programa preuniversitario" residencial`
- `site:.mx "Coahuila" "programa de verano" residencial preparatoria`
- `"Coahuila" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Coahuila" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Coahuila" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-coa-college-precollege-scan.json` if you can write files.
