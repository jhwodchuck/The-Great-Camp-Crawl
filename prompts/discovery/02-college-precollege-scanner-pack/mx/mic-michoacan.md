# Copy-Paste Discovery Prompt: MX / MIC / Michoacan — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-mic-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-mic-college-precollege-scan`
- `country`: `MX`
- `region`: `MIC`
- `region_name`: `Michoacan`
...
- `site:.mx "Michoacan" "programa preuniversitario" residencial`
- `site:.mx "Michoacan" "programa de verano" residencial preparatoria`
- `"Michoacan" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Michoacan" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Michoacan" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-mic-college-precollege-scan.json` if you can write files.
