# Copy-Paste Discovery Prompt: MX / BCS / Baja California Sur — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-bcs-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-bcs-college-precollege-scan`
- `country`: `MX`
- `region`: `BCS`
...
- `site:.mx "Baja California Sur" "programa preuniversitario" residencial`
- `site:.mx "Baja California Sur" "programa de verano" residencial preparatoria`
- `"Baja California Sur" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Baja California Sur" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Baja California Sur" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-bcs-college-precollege-scan.json` if you can write files.
