# Copy-Paste Discovery Prompt: MX / TAB / Tabasco — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-tab-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-tab-college-precollege-scan`
- `country`: `MX`
- `region`: `TAB`
- `region_name`: `Tabasco`
...
- `site:.mx "Tabasco" "programa preuniversitario" residencial`
- `site:.mx "Tabasco" "programa de verano" residencial preparatoria`
- `"Tabasco" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Tabasco" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Tabasco" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-tab-college-precollege-scan.json` if you can write files.
