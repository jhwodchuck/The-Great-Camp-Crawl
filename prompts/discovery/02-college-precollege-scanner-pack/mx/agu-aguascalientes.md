# Copy-Paste Discovery Prompt: MX / AGU / Aguascalientes — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-agu-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-agu-college-precollege-scan`
- `country`: `MX`
- `region`: `AGU`
...
- `site:.mx "Aguascalientes" "programa preuniversitario" residencial`
- `site:.mx "Aguascalientes" "programa de verano" residencial preparatoria`
- `"Aguascalientes" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Aguascalientes" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Aguascalientes" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-agu-college-precollege-scan.json` if you can write files.
