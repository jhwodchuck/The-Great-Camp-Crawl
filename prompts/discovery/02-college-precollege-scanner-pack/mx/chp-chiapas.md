# Copy-Paste Discovery Prompt: MX / CHP / Chiapas — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-chp-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-chp-college-precollege-scan`
- `country`: `MX`
- `region`: `CHP`
- `region_name`: `Chiapas`
...
- `site:.mx "Chiapas" "programa preuniversitario" residencial`
- `site:.mx "Chiapas" "programa de verano" residencial preparatoria`
- `"Chiapas" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Chiapas" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Chiapas" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-chp-college-precollege-scan.json` if you can write files.
