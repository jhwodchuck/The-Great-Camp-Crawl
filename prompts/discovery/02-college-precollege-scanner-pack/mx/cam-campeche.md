# Copy-Paste Discovery Prompt: MX / CAM / Campeche — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-cam-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-cam-college-precollege-scan`
- `country`: `MX`
- `region`: `CAM`
...
- `site:.mx "Campeche" "programa preuniversitario" residencial`
- `site:.mx "Campeche" "programa de verano" residencial preparatoria`
- `"Campeche" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Campeche" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Campeche" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-cam-college-precollege-scan.json` if you can write files.
