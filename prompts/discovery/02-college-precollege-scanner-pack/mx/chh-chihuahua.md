# Copy-Paste Discovery Prompt: MX / CHH / Chihuahua — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-chh-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-chh-college-precollege-scan`
- `country`: `MX`
- `region`: `CHH`
...
- `site:.mx "Chihuahua" "programa preuniversitario" residencial`
- `site:.mx "Chihuahua" "programa de verano" residencial preparatoria`
- `"Chihuahua" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Chihuahua" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Chihuahua" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-chh-college-precollege-scan.json` if you can write files.
