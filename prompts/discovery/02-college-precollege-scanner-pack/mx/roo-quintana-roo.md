# Copy-Paste Discovery Prompt: MX / ROO / Quintana Roo — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-roo-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-roo-college-precollege-scan`
- `country`: `MX`
- `region`: `ROO`
...
- `site:.mx "Quintana Roo" "programa preuniversitario" residencial`
- `site:.mx "Quintana Roo" "programa de verano" residencial preparatoria`
- `"Quintana Roo" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Quintana Roo" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Quintana Roo" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-roo-college-precollege-scan.json` if you can write files.
