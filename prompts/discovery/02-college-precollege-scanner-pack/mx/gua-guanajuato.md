# Copy-Paste Discovery Prompt: MX / GUA / Guanajuato — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-gua-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-gua-college-precollege-scan`
- `country`: `MX`
- `region`: `GUA`
...
- `site:.mx "Guanajuato" "programa preuniversitario" residencial`
- `site:.mx "Guanajuato" "programa de verano" residencial preparatoria`
- `"Guanajuato" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Guanajuato" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Guanajuato" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-gua-college-precollege-scan.json` if you can write files.
