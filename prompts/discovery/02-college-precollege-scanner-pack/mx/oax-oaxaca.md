# Copy-Paste Discovery Prompt: MX / OAX / Oaxaca — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-oax-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-oax-college-precollege-scan`
- `country`: `MX`
- `region`: `OAX`
- `region_name`: `Oaxaca`
...
- `site:.mx "Oaxaca" "programa preuniversitario" residencial`
- `site:.mx "Oaxaca" "programa de verano" residencial preparatoria`
- `"Oaxaca" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Oaxaca" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Oaxaca" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-oax-college-precollege-scan.json` if you can write files.
