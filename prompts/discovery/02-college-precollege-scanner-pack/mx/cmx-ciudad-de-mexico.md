# Copy-Paste Discovery Prompt: MX / CMX / Ciudad de Mexico — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-cmx-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-cmx-college-precollege-scan`
- `country`: `MX`
- `region`: `CMX`
...
- `site:.mx "Ciudad de Mexico" "programa preuniversitario" residencial`
- `site:.mx "Ciudad de Mexico" "programa de verano" residencial preparatoria`
- `"Ciudad de Mexico" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Ciudad de Mexico" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Ciudad de Mexico" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-cmx-college-precollege-scan.json` if you can write files.
