# Copy-Paste Discovery Prompt: MX / VER / Veracruz — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-ver-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-ver-college-precollege-scan`
- `country`: `MX`
- `region`: `VER`
...
- `site:.mx "Veracruz" "programa preuniversitario" residencial`
- `site:.mx "Veracruz" "programa de verano" residencial preparatoria`
- `"Veracruz" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Veracruz" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Veracruz" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-ver-college-precollege-scan.json` if you can write files.
