# Copy-Paste Discovery Prompt: MX / GRO / Guerrero — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-gro-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-gro-college-precollege-scan`
- `country`: `MX`
- `region`: `GRO`
...
- `site:.mx "Guerrero" "programa preuniversitario" residencial`
- `site:.mx "Guerrero" "programa de verano" residencial preparatoria`
- `"Guerrero" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Guerrero" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Guerrero" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-gro-college-precollege-scan.json` if you can write files.
