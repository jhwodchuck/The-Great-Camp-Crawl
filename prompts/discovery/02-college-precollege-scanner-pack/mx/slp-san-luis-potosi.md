# Copy-Paste Discovery Prompt: MX / SLP / San Luis Potosi — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-slp-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-slp-college-precollege-scan`
- `country`: `MX`
- `region`: `SLP`
...
- `site:.mx "San Luis Potosi" "programa preuniversitario" residencial`
- `site:.mx "San Luis Potosi" "programa de verano" residencial preparatoria`
- `"San Luis Potosi" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"San Luis Potosi" universidad "verano" "internado" OR "residencia" preparatoria`
- `"San Luis Potosi" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-slp-college-precollege-scan.json` if you can write files.
