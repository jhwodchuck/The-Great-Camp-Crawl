# Copy-Paste Discovery Prompt: MX / BCN / Baja California — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-bcn-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-bcn-college-precollege-scan`
- `country`: `MX`
- `region`: `BCN`
...
- `site:.mx "Baja California" "programa preuniversitario" residencial`
- `site:.mx "Baja California" "programa de verano" residencial preparatoria`
- `"Baja California" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Baja California" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Baja California" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-bcn-college-precollege-scan.json` if you can write files.
