# Copy-Paste Discovery Prompt: MX / MOR / Morelos — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-mor-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-mor-college-precollege-scan`
- `country`: `MX`
- `region`: `MOR`
- `region_name`: `Morelos`
...
- `site:.mx "Morelos" "programa preuniversitario" residencial`
- `site:.mx "Morelos" "programa de verano" residencial preparatoria`
- `"Morelos" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Morelos" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Morelos" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-mor-college-precollege-scan.json` if you can write files.
