# Copy-Paste Discovery Prompt: MX / TAM / Tamaulipas — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-tam-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-tam-college-precollege-scan`
- `country`: `MX`
- `region`: `TAM`
...
- `site:.mx "Tamaulipas" "programa preuniversitario" residencial`
- `site:.mx "Tamaulipas" "programa de verano" residencial preparatoria`
- `"Tamaulipas" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Tamaulipas" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Tamaulipas" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-tam-college-precollege-scan.json` if you can write files.
