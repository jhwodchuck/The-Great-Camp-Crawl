# Copy-Paste Discovery Prompt: MX / ZAC / Zacatecas — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/mx-zac-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `mx-zac-college-precollege-scan`
- `country`: `MX`
- `region`: `ZAC`
...
- `site:.mx "Zacatecas" "programa preuniversitario" residencial`
- `site:.mx "Zacatecas" "programa de verano" residencial preparatoria`
- `"Zacatecas" universidad "campamento" residencial "preparatoria" OR "bachillerato"`
- `"Zacatecas" universidad "verano" "internado" OR "residencia" preparatoria`
- `"Zacatecas" colegio "programa residencial" preparatoria`
...
- Save the JSON to `reports/discovery/mx-zac-college-precollege-scan.json` if you can write files.
