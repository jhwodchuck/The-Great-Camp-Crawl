# Copy-Paste Discovery Prompt: US / MD / Maryland
...
- Save the gathered report to `reports/discovery/us-md-country-region-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-md-country-region-scan`
- `country`: `US`
- `region`: `MD`
...
- `"overnight summer camp" "Maryland"`
- `"residential summer camp" "Maryland"`
- `"family camp" "Maryland"`
- `"youth retreat" "Maryland" overnight`
...
- Save the JSON to `reports/discovery/us-md-country-region-scan.json` if you can write files.
