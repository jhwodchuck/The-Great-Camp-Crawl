# Copy-Paste Discovery Prompt: US / ME / Maine
...
- Save the gathered report to `reports/discovery/us-me-country-region-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-me-country-region-scan`
- `country`: `US`
- `region`: `ME`
- `region_name`: `Maine`
...
- `"overnight summer camp" "Maine"`
- `"residential summer camp" "Maine"`
- `"family camp" "Maine"`
- `"youth retreat" "Maine" overnight`
...
- Save the JSON to `reports/discovery/us-me-country-region-scan.json` if you can write files.
