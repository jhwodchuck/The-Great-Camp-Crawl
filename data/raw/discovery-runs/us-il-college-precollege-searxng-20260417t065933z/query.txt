# Copy-Paste Discovery Prompt: US / IL / Illinois — College Pre-College Scanner
...
- Save the gathered report to `reports/discovery/us-il-college-precollege-scan.json` if you have file-write access.
- If you do not have file-write access, return only the JSON object so it can be saved to that path.

Assigned slice:

- `run_slug`: `us-il-college-precollege-scan`
- `country`: `US`
- `region`: `IL`
...
- `site:.edu "Illinois" "pre-college" residential`
- `site:.edu "Illinois" "summer program" residential overnight`
- `site:.edu "Illinois" "summer immersion" OR "summer institute" residential`
- `"Illinois" university "summer camp" residential "high school"`
- `"Illinois" college "summer program" residential "boarding" OR "dorm"`
...
- Save the JSON to `reports/discovery/us-il-college-precollege-scan.json` if you can write files.
